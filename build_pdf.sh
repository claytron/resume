...
[ -n "$1" ] && height="$1" || height='840mm'

make clean && make html

rsync -av _build/html/ claytron.com:/usr/local/www/data/resume

wkhtmltopdf --user-style-sheet pdf.css  -B 0 -L 0 -R 0 -T 0 --page-width 210mm --page-height $height --disable-forms page http://claytron.com/static/resume/ _build/html/resume.pdf
