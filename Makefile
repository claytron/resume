...
qthelp:
	...
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/resume.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/resume"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/resume"
	@echo "# devhelp"
